/*
  Hydrogen_Simulator.c - A simulator for a hydrogen atom interacting with an intense electromagnetic field using the time-dependent
  configuration interaction method to solve the time-dependent configuration interaction method.
  
    Copyright (C) 2017  Jonathan J. Foley IV, Henrietta Eugene, Brymor Anderson, 
    Rana Daher, Laura Perdomo-Quintero, Oyewumi Akinfenwa, Muttalib Khan.
